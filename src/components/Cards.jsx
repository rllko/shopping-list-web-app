function Cards(){
    return(
    <div className="grid grid-rows-[1.05fr,1fr,0.6fr] gap-0 bg-white ">
    ...
    <section className="max-h-[10vh] h-full  md:m-0 ">
        <div className="flex justify-center space-x-4  md:space-x-0 mx-auto items-center flex-wrap
                        md:flex-nowrap 
                        xl:justify-center xl:max-w-6xl w-[90%] sm:w-full md:w-[65%] lg:w-[62%] 2xl:w-[60%]">

                <p className="text-zinc-600 text-center my-1 md:mx-10 mx-12 lg:mx-0 text-md md:text-md md:w-[55%] xl:px-36 2xl:px-0 xl:w-[50%] 2xl:mx-20 xl:text-xl lg:text-lg/6 md:pt-4">
                    Never run out of ideas with our large list of recipes that range from a simple cake to the best pasta.
                </p>
            <div className="my-4">
                <img src="./img/receita.svg" className=" w-48 md:w-62 xl:w-62 2xl:w-72 md:w-full " alt="" />
            </div>
            </div>
    </section>
    </div>)
