    ...
    <main className="sticky top-0 z-50  bg-white">
        <header className=" top-0 flex items-center justify-between ml-5 mr-1 xl:ml-10">
            ...
            <div className="flex flex-row items-center space-x-3 xl:grid-cols-1">
                <button className="flex justify-center items-center rounded-lg border-2 mr-3 relative w-[8vh] align-text-top h-full border-black hover:bg-gradient-to-tr cursor-pointer hover:from-orange-100 shadow-solid hover:to-orange-300 text-md transition-all duration-200 hover:font-bold">
                    Login
                </button>
                <div className="xl:hidden flex ml-auto pr-4 cursor-pointer relative">
                    ...
                    <div className={`absolute transition-all ${isSidebarEnabled? "block" : "hidden"} z-40 -right-1 w-[100vw] top-11 text-center bg-white`}>
