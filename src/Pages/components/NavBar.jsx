...
function NavBar(){
    ...
    <main className="sticky top-0 z-50 bg-white ">
        <header className="flex items-center justify-between w-full max-w-[95%] sm:max-w-2xl md:max-w-5xl xl:max-w-7xl 2xl:max-w-7xl md:mx-auto">
            <Link className="" draggable="false" to={'/'}>
                <img className="p-2 ml-[.5em] hover:cursor-pointer hover:w-[52%] duration-200 hover:transition-all" draggable="false"  src="/img/logo nobg small.png" width={150} alt="" />
            </Link>

            <nav className="md:!flex hidden "> 
                <div className=" relative flex gap-0 mx-auto items-center justify-center">
                    <NavLink to={'/login'} draggable="false"
                    className={(({isActive}) => { 
                        return isActive ? 
                    ...
                    <NavLink to={'/lists'} draggable="false"
                    className={(({isActive}) => { 
                        return isActive ? 
                        `text-lg text-black hover:!font-semibold transition-all duration-100 p-5 bg-orange-100/50 h-full cursor-pointer hover:!text-black` 
                        : 'text-lg !text-black hover:!font-semibold transition-all duration-100 p-5 hover:!bg-orange-100/50 h-full hover:cursor-pointer'})}
                    ...
                    <NavLink to={'/about'} draggable="false"
                    className={(({isActive}) => { 
                        return isActive ? 
                        `text-lg text-black hover:!font-semibold transition-all duration-100 p-5 bg-orange-100/50 h-full cursor-pointer hover:!text-black` 
                        : 'text-lg !text-black hover:!font-semibold transition-all duration-100 p-5 hover:!bg-orange-100/50 h-full hover:cursor-pointer'})}
            ...
            <div className="flex md:hidden flex-row items-center">
                <div className="md:hidden flex mx-auto lg:pr-4 -right-3 cursor-pointer relative mt-1 mr-[.5em]">
                    ...
                    <NavLink draggable="false" to={'/login'} className="text-lg text-black hover:font-semibold h-12 flex items-center hover:text-black justify-center hover:bg-orange-100 hover:cursor-pointer">Login</NavLink>
                    <NavLink draggable="false" to={'/lists'} className="text-lg text-black hover:font-semibold h-12 flex items-center hover:text-black justify-center hover:bg-orange-100 hover:cursor-pointer">Lists</NavLink>
                    <NavLink draggable="false" to={'/recipes'} className="text-lg text-black hover:font-semibold h-12 flex items-center hover:text-black justify-center hover:bg-orange-100 hover:cursor-pointer">Recipes</NavLink>
                    <NavLink draggable="false" to={'/about'} className="text-lg text-black hover:font-semibold h-12 flex items-center hover:text-black justify-center hover:bg-orange-100 hover:cursor-pointer">About</NavLink>
                    </div>
                </div>
            </div>
        </header>
