...
function Cards(){
    return(
    <div  className="flex flex-col gap-0 md:gap-10 xl:gap-0">
        <div className="min-h-screen grid grid-rows-[.45fr,.4fr] lg:grid-rows-[.7fr,.35fr]">
            ...
            <section className="flex flex-col md:flex-row items-center lg:gap-12 xl:w-[45%] xl:mx-auto xl:gap-2 justify-center md:mt-0">
                    <div className="">
                    ...
                    <div className="flex md:w-[85%] items-center lg:items-start lg:w-[50%] xl:w-full flex-col gap-2 lg:gap-4 ">
                        <p className="text-zinc-600 text-center lg:text-left  w-[80%] lg:text-2xl md:text-2xl/8 xl:text-2xl md:w-[80%] mx-auto lg:w-[80%] xl:w-full 2xl:w-[80%] mb-4 2xl:text-3xl md:pt-4">
                            Create a digital list to organize your shopping and save time and paper.
                        </p>
                        <Link to={'/shopping-list-web-app/register'} className= 
                        "text-base w-fit md:text-left text-center lg:mx-auto xl:ml-auto p-2 md:text-xl 2xl:text-xl lg:text-xl lg:p-3 xl:text-base mb-2 bg-transparent lg:block \
                    ...
                    <div className="-mx-3 md:flex items-start">
                            ...
                            <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                                <div className="w-full flex mb-4 items-center">
                                    ...
                                    <div className="flex-grow pl-3">
                                        <h6 className="font-bold text-base uppercase text-gray-600">Kenzie Edgar.</h6>
                                    </div>
                                </div>
                                <div className="w-full">
                                    <p className="text-sm leading-tight"><span className="text-xl leading-none italic font-bold text-gray-400 mr-1">"</span>MixList has revolutionized my shopping and cooking experience. It's so easy to organize my grocery lists and find new recipes all in one place!<span className="text-lg leading-none italic font-bold text-gray-400 ml-1">"</span></p>
                                </div>
                            </div>
                            <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                                <div className="w-full flex mb-4 items-center">
                                    ...
                                    <div className="flex-grow pl-3">
                                        <h6 className="font-bold text-base uppercase text-gray-600">Stevie Tifft.</h6>
                                    </div>
                                </div>
                                <div className="w-full">
                        ...
                        <div className="px-3 md:w-1/3">
                            <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                                ...
                                <div className="w-full">
                                    <p className="text-sm leading-tight"><span className="text-lg leading-none italic font-bold text-gray-400 mr-1">"</span>MixList is incredibly user-friendly. I appreciate how it simplifies my grocery shopping and meal preparation.<span className="text-lg leading-none italic font-bold text-gray-400 ml-1">"</span></p>
                                </div>
                            </div>
                            <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                                <div className="w-full flex mb-4 items-center">
